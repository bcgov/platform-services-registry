    ...
    <Layout>
      <div className="pb-6 mt-4 mb-4 border-solid border-0 border-b-1 border-slate-300">
        ...
        <Text className="">
          ...
          or use the button below and you&apos;ll see all four namespaces included in a project set. If you have any
        ...
        <Text className="">
          The Product Owner and the Technical Lead(s) have been provisioned with admin access to the namespaces below
          and can add other users as needed.
        </Text>
        <Text className="">
      ...
      <div className="pb-6 mt-4 mb-4 border-solid border-0 border-b-1 border-slate-300">
        <div>
          ...
          <Text className="">
            Your new OpenShift project set includes access to free security tools available to product teams on the
            Private Cloud OpenShift, including:
          </Text>
          <ul>
            <li>
