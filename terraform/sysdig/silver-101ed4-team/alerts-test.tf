resource "sysdig_monitor_alert_v2_metric" "test_pltsvc_db_pod_memory" {
  enabled     = false
...
resource "sysdig_monitor_alert_v2_metric" "test_pltsvc_db_pod_cpu" {
  enabled     = false
...
resource "sysdig_monitor_alert_v2_metric" "test_pltsvc_app_pod_memory" {
  enabled     = false
...
resource "sysdig_monitor_alert_v2_metric" "test_pltsvc_app_pod_cpu" {
  enabled     = false
