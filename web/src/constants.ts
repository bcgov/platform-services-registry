...
export const NAMESPACE_URLS =  {
  ...
  TOOLS_GOLD: process.env.REACT_APP_TOOLS_NAMESPACE_GOLD_URL,
  PROD_SILVER: process.env.REACT_APP_PRODUCTION_NAMESPACE_SILVER_URL,
  DEV_SILVER: process.env.REACT_APP_DEVELOPMENT_NAMESPACE_SILVER_URL,
  TEST_SILVER: process.env.REACT_APP_TEST_NAMESPACE_SILVER_URL,
  TOOLS_SILVER: process.env.REACT_APP_TOOLS_NAMESPACE_SILVER_URL,
};
