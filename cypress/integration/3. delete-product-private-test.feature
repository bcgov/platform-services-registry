Feature: Delete Request
  Scenario: Delete Request and check visibility
    ...
    And User types "Automated Deletion Test Product Name" in "Product name"
    And User types "Automated Deletion Test Description" in "Description"
   ...
   And User chooses to add contact "Project Owner"
    ...
    And User should see "Automated Deletion Test Product Name"
    And User logs out
    ...
    And User waits for "3" seconds
    And User clicks link "Automated Deletion Test Product Name"
    ...
    And User clicks tab "Requests"
    Then User should see "Automated Deletion Test Product Name"
