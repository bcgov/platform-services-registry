Feature: Edit Request Compare Data
  ...
  Scenario: Create Public Cloud Edit Request and Compare Data
    ...
    And User waits for "2" seconds
    And User should see "Automated Test Product Name Compare Data"
    And User logs out
    ...
    Then User should see "Automated Test Product Name Compare Data"
    And User logs out
    ...
    And User checks that select "Cloud Service Provider" value is "AWS"
