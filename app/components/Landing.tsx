...
export default function Landing() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <h1 className="text-3xl font-semibold text-gray-900 mb-12 tracking-wider">
        Private Cloud OpenShift Platform and Public Cloud Landing Zone
      </h1>

      <h2 className="text-xl font-semibold text-gray-900 tracking-wider mb-4">Make changes to an existing product</h2>

      <p className="mb-4">
        For existing applications hosted on OpenShift 4 Platform or B.C. Government Public Cloud Landing Zone.
      </p>
      ...
      <h2 className="text-xl font-semibold text-gray-900 tracking-wider mb-4">Register a new product</h2>
      ...
      <ul className="list-disc m-0 pl-8">
        <li className="mb-2">
          <ExternalLink href="https://digital.gov.bc.ca/cloud/services/private/intro/" className="text-base">
            Private cloud hosting
          </ExternalLink>
        </li>
        <li className="mb-2">
          <ExternalLink href="https://digital.gov.bc.ca/cloud/services/public/intro/" className="text-base">
      ...
      <ul>
        <li>
          ...
          <ExternalLink href="https://digital.gov.bc.ca/cloud/services/private/onboard/" className="text-base">
        ...
        <li>
          ...
          <ExternalLink href="https://digital.gov.bc.ca/cloud/services/public/onboard/" className="text-base">
