...
>({
  ...
  let pathParams: TypeOf<typeof pathParamVal> = pathParamVal.parse({});
  let queryParams: TypeOf<typeof queryParamVal> = queryParamVal.parse({});
  let body: TypeOf<typeof bodyVal> = bodyVal.parse({});
