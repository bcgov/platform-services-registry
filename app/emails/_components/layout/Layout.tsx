...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <Html>
      ...
      <Body className="bg-grey my-auto mx-auto font-sans text-xs text-darkergrey">
        <Tailwind config={tailwindConfig}>
          <div className="border border-solid border-[#eaeaea] rounded-sm my-4 mx-auto p-4 max-w-xl bg-grey">
            <Header />
