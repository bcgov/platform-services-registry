...
export async function POST(req: NextRequest, { params }: { params: Params }) {
  ...
  if (request.decisionStatus !== DecisionStatus.APPROVED) {
    ...
    return new NextResponse(`Request for ${request.licencePlate} successfullycreated as rejected.`, {
      status: 200,
    });
  }
  ...
  return new NextResponse(`Decision request for ${request.licencePlate} successfullycreated.`, {
    status: 200,
  });
}
