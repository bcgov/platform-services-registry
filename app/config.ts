...
export const MAILCHIMP_SEGMENT_LIST_ID = process.env.MAILCHIMP_SEGMENT_LIST_ID || '';
export const MAILCHIMP_SEGMENT_API_KEY = process.env.MAILCHIMP_SEGMENT_API_KEY || '';
export const MAILCHIMP_SEGMENT_SERVER_PREFIX = process.env.MAILCHIMP_SEGMENT_SERVER_PREFIX || '';
