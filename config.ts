...
export const PRIVATE_NATS_HOST = process.env.NATS_HOST || 'localhost';
export const PRIVATE_NATS_PORT = process.env.NATS_PORT || '4222';
export const PUBLIC_NATS_HOST = process.env.NATS_HOST || 'localhost';
export const PUBLIC_NATS_PORT = process.env.NATS_PORT || '4222';
