...
MS_GRAPH_API_TENANT_ID = os.getenv("PROD_MS_GRAPH_API_TENANT_ID")
MS_GRAPH_API_CLIENT_ID = os.getenv("PROD_MS_GRAPH_API_CLIENT_ID")
MS_GRAPH_API_CLIENT_PRIVATE_KEY = os.getenv("PROD_MS_GRAPH_API_CLIENT_PRIVATE_KEY")
MS_GRAPH_API_CLIENT_CERTIFICATE = os.getenv("PROD_MS_GRAPH_API_CLIENT_CERTIFICATE")
