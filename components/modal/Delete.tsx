              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl sm:p-6">
                <div className="space-y-4">
                  ...
                  {isLoading ? (
                    <svg
                      aria-hidden="true"
                      className="w-2 h-2 text-gray-200 animate-spin dark:text-gray-200 fill-blue-600"
                      viewBox="0 0 100 101"
                      fill="none"
                  ...
                  <div className="border-t border-gray-300 pt-4">
                    ...
                    {deletionCheckData !== 'OK_TO_DELETE' ? (
                      <div className="mt-8 text-sm font-medium">
                        Our deletion check did not pass, this means that there are still resources deployed on this
                        namespace.
                      </div>
                    ) : (
                      <div>
