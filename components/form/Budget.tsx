  ...
  return (
    <div className="border-b border-gray-900/10 pb-14">
      ...
      <p className="font-bcsans text-base leading-6 mt-5">
        Please indicate your estimated monthly budget &#40;Try the <a
          className="text-blue-600 dark:text-blue-500 hover:underline"
          href={'https://www.thoughtco.com/html-code-for-common-symbols-and-signs-2654021'}
        >
          AWS Cost Calculator
        </a> to get an estimate&#41;. Provide an estimated average monthly spend allocated to your cloud service usage for
