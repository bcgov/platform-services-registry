  ...
  return (
    <div className="border-b border-gray-900/10 pb-14">
      ...
      <p className="font-bcsans text-base leading-6 mt-5">
        ...
        this request, you will be provisioned with four accounts - Dev, Test,
        Prod and Tools. Please specify the estimate for each of these accounts.{" "}
        <b>
          Please note that this estimate are projected numbers that will only be
          used to send your team a warning when the monthly spend reaches 80% of
