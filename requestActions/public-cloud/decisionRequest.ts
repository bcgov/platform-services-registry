...
export type PublicCloudRequestWithRequestedProject =
...
export default async function makeDecisionRequest(
  ...
  // Get the request
  const request: PublicCloudRequestWithRequestedProject | null =
  ...
  const decisionRequest: PublicCloudRequestWithRequestedProject | null =
